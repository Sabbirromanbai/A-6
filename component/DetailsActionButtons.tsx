  ...
  return (
    <div className="flex items-center gap-2.5 pt-2 flex-wrap">
      ...
      <button
        ...
        className="bg-[#cfff04] hover:bg-[#b5e000] text-black font-extrabold text-xs px-5 py-2.5 rounded-lg transition-all active:scale-95 flex items-center gap-2 shadow-sm cursor-pointer"
      >
        <svg
